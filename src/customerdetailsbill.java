...
public class customerdetailsbill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(328, 125, -1, -1));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(551, 123, 188, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(798, 121, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Phone", "Nationality", "Genderl", "Emaill", "IdProof", "Address", "CheckInDate", "RoomNumber", "Bed", "RoomType", "PricePer Day", "Numof DayStay", "TotalAmount", "CheckOutDate"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 197, 1437, 240));

        jButton2.setIcon(new javax.swing.ImageIcon("C:\\Users\\INSA\\Desktop\\javatutrial\\banksystem\\Application-cancel.png")); // NOI18N
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 480, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         ...
         ResultSet rs=Select.getData("select *from customers where checkout ='"+checkoutdate+"'");
        DefaultTableModel model=( DefaultTableModel)jTable1.getModel();
         model.setRowCount(0);
